...
impl epi::App for App {
    ...
    fn update(&mut self, ctx: &egui::CtxRef, _frame: &mut epi::Frame<'_>) {
        ...
        egui::CentralPanel::default().show(ctx, |ui| {
            ...
            ui.spacing_mut().slider_width = ui.available_width() - 400.0;
            ...
            ui.vertical_centered_justified(|ui| {
                ...
                egui::ComboBox::from_label("Pulse Mode")
                    ...
                    .show_ui(ui, |ui| {
                        ...
                        ui.selectable_value(
                            &mut self.led_state.pulse_mode,
                            PulseMode::Breathing {
                                interval_ms: NonZeroU16::new(
                                    self.led_state.if_breathing_interval_ms,
                                )
                                .unwrap(),
                            },
                            "Breathing",
                ...
                ui.scope(|ui| {
                    ui.set_visible(matches!(
                        self.led_state.pulse_mode,
                        PulseMode::Breathing { .. }
                    ));
                ...
                ui.heading(format!("Serial Monitor (last {} messages)", SHOW_LAST_COMMAND_NUM));
                ui.group(|ui| {
